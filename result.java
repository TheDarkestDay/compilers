...
public class BCELTestCreator implements Constants {
  ...
  private void createMethod_1() {
    ...
    InstructionHandle ih_0 = il.append(_factory.createLoad(Type.INT, 0));
    il.append(new PUSH(_cp, 3));
    il.append(InstructionConstants.IMUL);
    InstructionHandle ih_3 = il.append(_factory.createReturn(Type.INT));
    method.setMaxStack();
    method.setMaxLocals();
    _cg.addMethod(method.getMethod());
    il.dispose();
  ...
  private void createMethod_2() {
    ...
    InstructionHandle ih_5 = il.append(new PUSH(_cp, 3.14));
    il.append(_factory.createStore(Type.DOUBLE, 2));
    InstructionHandle ih_9 = il.append(new PUSH(_cp, 4));
    il.append(_factory.createStore(Type.INT, 4));
    InstructionHandle ih_12 = il.append(new PUSH(_cp, 8));
    il.append(_factory.createStore(Type.INT, 5));
    InstructionHandle ih_16 = il.append(new PUSH(_cp, 10));
